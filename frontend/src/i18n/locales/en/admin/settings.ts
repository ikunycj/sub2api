export default {
    settings: {
      ...
      payment: {
        ...
        displayMode: 'Payment Entry Display',
        displayModeHint: 'Control whether users see the full payment flow, plan-only external subscription cards, or no payment entry.',
        modeOff: 'Off',
        modePayment: 'Payments',
        modePlans: 'Plans Only',
        modePlansHint: 'Plans-only mode shows subscription cards and uses external subscription links or instructions instead of creating in-site payment orders.',
        ...
        field_descriptor: 'Payment descriptor',
