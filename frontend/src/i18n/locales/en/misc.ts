export default {
  ...
  payment: {
    ...
    renewNow: 'Renew',
    externalSubscribe: 'Subscribe Externally',
    externalSubscribeClose: 'Close',
    externalSubscribeDialogFallbackTitle: 'Subscription Instructions',
    ...
    admin: {
      ...
      price: 'Price',
      priceHint: 'Enter plan prices in USD. If CNY conversion is enabled, the charged amount is calculated from the configured rate.',
      ...
      validityPermanentHint: 'Use 0 for permanent validity.',
      sortOrder: 'Sort Order',
      forSale: 'For Sale',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
      groupOptionalHint: 'Leave empty for balance top-up plans; choose a subscription group for subscription plans.',
      groupId: 'Group ID',
      features: 'Features',
      ...
      unlimited: 'Unlimited',
      externalSubscribe: 'External Subscription',
      externalSubscribeHint: 'When enabled, plan buttons open an external link or show subscription instructions instead of creating in-site payment orders.',
      externalSubscribeTargetType: 'Subscription Method',
      externalSubscribeTargetUrl: 'External Link',
      externalSubscribeTargetDialog: 'Instruction Dialog',
      externalSubscribeUrl: 'External Subscription URL',
      externalSubscribeUrlPlaceholder: 'https://example.com/subscribe',
      externalSubscribeDialogText: 'Subscription Instructions',
      externalSubscribeDialogTextPlaceholder: 'Enter the instructions users will see after clicking subscribe...',
      externalSubscribeDialogTextHint: 'Line breaks are supported for contact, redemption, or activation instructions.',
      externalSubscribeTargetRequired: 'Configure an external subscription URL or instruction text first',
      externalSubscribeUrlRequired: 'Enter an external subscription URL',
      externalSubscribeDialogTextRequired: 'Enter subscription instruction text',
