export default {
  ...
  payment: {
    ...
    admin: {
      ...
      externalSubscribeHint: '仅展示套餐模式下，开启后用户可点击按钮跳转外链，或查看一段主题弹窗说明；两种方式二选一。',
      ...
      externalSubscribeDialogTextHint: '填写后，用户点击“前往订阅”只会看到这段主题弹窗说明；如需跳转外链，请切换为“跳转外链”。',
      ...
      groupRequired: '请选择订阅分组',
      groupOptionalHint: '可不选择分组；留空时该套餐作为固定余额充值套餐。',
      priceHint: '用户看到并用于支付的套餐价格。',
      priceRequired: '价格必须大于 0',
      validityDaysRequired: '有效期天数不能小于 0',
      validityPermanentHint: '留空或填写 0 表示永久有效。',
      groupMissing: '缺失',
      groupInfo: '分组信息',
      platform: '平台',
