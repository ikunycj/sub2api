export default {
  ...
  payment: {
    ...
    tabTopUp: 'Balance Top-Up',
    tabSubscribe: 'Plan Top-Up',
    noPlans: 'No subscription plans available',
    noBalancePlans: 'No balance top-up plans available',
    ...
    admin: {
      ...
      externalSubscribeHint: 'In plans-only mode, users can either open an external page or review a themed dialog; choose one action per plan.',
      ...
      externalSubscribeDialogTextHint: 'When filled, users will only see this themed dialog. Switch to External URL if the plan should open a subscribe link.',
      ...
      selectGroup: 'Select a group',
      selectValidityUnit: 'Select a validity unit',
      groupRequired: 'Please select a subscription group',
      groupOptionalHint: 'Leave group empty to make this a fixed balance top-up plan.',
      priceHint: 'The amount displayed to users and used for payment.',
      priceRequired: 'Price must be greater than 0',
      validityDaysRequired: 'Validity days cannot be less than 0',
      validityPermanentHint: 'Leave empty or enter 0 for permanent validity.',
