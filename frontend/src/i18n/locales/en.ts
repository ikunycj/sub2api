export default {
  ...
  home: {
    ...
    features: {
      unifiedGateway: 'One-Click Ikun',
      unifiedGatewayDesc: 'Get a single API key to call all connected AI models. No separate applications needed.',
      multiAccount: 'Steady Midrange',
      multiAccountDesc: 'Multi-account routing, retries, and automatic failover when it matters.',
      balanceQuota: 'Clear Usage',
      balanceQuotaDesc: 'Quota, cost, and team consumption stay visible. Pay only for what you use.'
    },
    // Comparison section
    comparison: {
      title: 'Why Choose Us?',
  ...
  aiStudio: {
    title: 'Chat & Images',
    description: 'Use AI chat and image generation inside the console',
    pendingApi: 'Use your current account API keys for chat and images',
    entry: {
      badge: 'Lightweight AI assistant',
      title: 'Start a new window for chat or image generation',
      description: 'Chat and images share one input box. Once inside, switch modes at the bottom or return here to start over.',
      chatTitle: 'Regular Chat',
      chatDescription: 'For Q&A, translation, writing, code explanation, and prompt drafting.',
      imageTitle: 'Generate Images',
      imageDescription: 'Turn a short idea into visual directions, poster drafts, or reference images.',
      startChat: 'Start Chat',
      startImage: 'Start Images',
      windowTitle: 'Choose a mode to begin',
      windowSubtitle: 'Manage history and parameters on the left, chat on the right',
    },
    conversation: {
      back: 'Back',
      chatGreeting: 'What would you like to talk about?',
      imageGreeting: 'Describe the image you want',
      chatHint: 'Use it like a mainstream AI chat app. Replies stream in real time.',
      imageHint: 'Image mode uses the same input box, but submits the prompt as an image request.',
      footerHint: 'Chat and images will reuse the current account balance, group permissions, and billing rules.',
    },
    input: {
      chatPlaceholder: 'Message AI, press Enter to send...',
      imagePlaceholder: 'Describe the image, press Enter to submit...',
      upload: 'Upload files',
      attachmentOnlyMessage: 'Files uploaded. Please use the attachments in this request.',
    },
    stats: {
      balance: 'Balance',
    ...
    side: {
      newChat: 'New Chat',
      history: 'History',
      serverRetention: 'Server keeps the latest 14 days only',
      searchPlaceholder: 'Search history...',
      noHistory: 'No matching history',
      localBadge: 'Local',
      autoBadge: 'Auto saved',
    },
    settings: {
      title: 'Chat Settings',
      description: 'Choose an API key, model, and common parameters. Requests reuse the key group permissions and available models.',
      historyStorageTitle: 'History Storage',
      historyStorageHint: 'Server history is kept for 2 weeks by default. Save the current session to this browser for long-term local retention.',
      saveLocalHistory: 'Save Locally',
      autoSaveLocalHistory: 'Auto-save locally',
      autoSaveLocalHistoryHint: 'When enabled, this browser keeps conversation history automatically instead of relying on the server 14-day retention.',
      autoSaveEnabled: 'Local auto-save enabled',
      localHistoryRetention: 'Auto-delete local conversations',
      localHistoryRetentionHint: 'Set a number of days to automatically delete locally saved conversations older than that. Leave empty to keep them.',
      noRetentionLimit: 'No limit',
      daysAfter: 'days later',
      localHistoryCount: '{count} sessions are saved in this browser',
      localHistorySaved: 'Current session saved to this browser',
      apiKey: 'API Key',
      apiKeyPlaceholder: 'No API key',
      noAPIKey: 'No API key selected',
      noAPIKeyMessage: 'No API key yet. Create one in the API Keys menu and bind it to an OpenAI group first. Go there now?',
      noUsableAPIKey: 'No API key usable by AI Studio',
      noUsableAPIKeyHint: 'You have API keys, but none can be used by AI Studio: {reason}',
      noUsableAPIKeyMessage: 'You have API keys, but no usable OpenAI group key for AI Studio: {reason}. Go to API Keys to adjust it?',
      selectedKeyUnavailable: 'Current key is unavailable: {reason}',
      unavailableKey: 'Unavailable',
      unavailableKeySummary: '{name} unavailable',
      noGroup: 'No group',
      goManageAPIKey: 'Manage API Keys',
      goCreateAPIKey: 'Create API Key',
      modelUnavailable: 'No available model for this key',
      apiKeyUnavailableReasons: {
        disabled: 'API key is disabled',
        expired: 'API key has expired',
        quotaExhausted: 'API key quota is exhausted',
        missingGroup: 'No group bound',
        nonOpenAIGroup: 'Only OpenAI groups are supported',
        groupDisabled: 'Bound group is disabled',
        unknown: 'Temporarily unavailable',
      },
      group: 'Group',
      temperature: 'Temperature',
      creativity: 'Creativity',
      temperatureHint: 'Lower is steadier; higher is more varied and creative.',
      moreParameters: 'More parameters',
      chatModel: 'Chat Model',
      imageModel: 'Image Model',
      maxTokens: 'Max Tokens',
      thinkingMode: 'Thinking Mode',
      thinkingModeHint: 'Requests reasoning summaries for complex tasks. Unsupported models may return an error.',
      reasoningEffort: 'Reasoning Effort',
      ...
      systemPromptPlaceholder: 'Example: You are a concise and accurate in-console AI assistant.',
    ...
    history: {
      summer: 'Summer campaign prompt',
      poster: 'Orange-white poster draft',
      code: 'API call example explanation',
      avatar: 'Social avatar image direction',
      today: 'Today',
      yesterday: 'Yesterday',
      monday: 'Monday',
      lastWeek: 'Last week',
    ...
    actions: {
      ...
      delete: 'Delete',
      deleteConfirm: 'Delete this conversation history?',
    },
    sample: {
      assistant: 'Hi, I can help with writing, analysis, coding ideas, and turning rough thoughts into image prompts.',
      user: 'Turn “summer member campaign” into a poster generation prompt.',
      reply: 'Suggested prompt: summer member campaign poster, fresh orange and white palette, iced drink glass, sunlit texture, clean Chinese headline, ecommerce operations style, leaving room for CTA and pricing details.',
      imageUser: 'Generate two orange-white membership campaign poster directions.',
      imageReply: 'Generated 2 preview directions for you. Once the real API is wired, upstream image results will appear here.',
      pendingReply: 'Got it. Once the real API is wired, the model response will stream here.',
    },
    chat: {
      title: 'AI Chat',
      subtitle: 'For Q&A, copy, code, and prompt drafting',
      copy: 'Copy',
      edit: 'Edit',
      resend: 'Resend',
      editPlaceholder: 'Edit this message and resend...',
      waiting: 'Thinking',
      thinking: 'Thinking',
    ...
    image: {
      title: 'AI Images',
      subtitle: 'Turn ideas into quick visual directions',
      completed: 'Image generation completed',
    },
    errors: {
      loadHistoryFailed: 'Failed to load server history',
      loadConversationFailed: 'Failed to load conversation',
      renameFailed: 'Rename failed',
      deleteFailed: 'Delete failed',
      updateFailed: 'Update failed',
      loadKeyOptionsFailed: 'Failed to load API keys',
      runFailed: 'Request failed',
      emptyResponse: 'The request ended without content. Please check whether this API key group has available accounts.',
    },
  },
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        displayMode: 'Payment Display Mode',
        displayModeHint: 'Choose one mode: hide payment, enable full payment, or show plans only.',
        modeOff: 'Off',
        modePayment: 'Enable Payment',
        modePlans: 'Show Plans',
        modePlansHint: 'Users can browse subscription plans, but payment methods, recharge, and order creation stay disabled.',
  ...
  payment: {
    ...
    externalSubscribeContinue: 'Continue to Subscribe',
    externalSubscribeClose: 'Maybe Later',
    externalSubscribeDialogFallbackTitle: 'Please review the subscription instructions first',
    ...
    admin: {
      ...
      forSale: 'For Sale',
      externalSubscribe: 'External Subscribe',
      externalSubscribeHint: 'In plans-only mode, users can click this button to open an external page directly or review a themed dialog first.',
      externalSubscribeTargetType: 'Subscription Action',
      externalSubscribeTargetUrl: 'External URL',
      externalSubscribeTargetDialog: 'Dialog Text',
      externalSubscribeUrl: 'Subscribe URL',
      externalSubscribeUrlPlaceholder: 'https://example.com/subscribe',
      externalSubscribeUrlRequired: 'Enter a subscribe URL first',
      externalSubscribeDialogText: 'Subscription Dialog Text',
      externalSubscribeDialogTextHint: 'When filled, users will see this themed dialog before leaving the site. If a URL is also provided, they can continue from the dialog.',
      externalSubscribeDialogTextPlaceholder: 'For example: contact support first or follow the group onboarding instructions.',
      externalSubscribeDialogTextRequired: 'Enter dialog text first',
      externalSubscribeTargetRequired: 'Enter a subscribe URL or dialog text first',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
      groupId: 'Group ID',
