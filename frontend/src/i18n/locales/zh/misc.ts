export default {
  ...
  payment: {
    ...
    rechargeNow: '立即充值',
    renewNow: '续费',
    externalSubscribe: '立即订阅',
    externalSubscribeClose: '关闭',
    externalSubscribeDialogFallbackTitle: '订阅说明',
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
    ...
    admin: {
      ...
      originalPrice: '原价',
      price: '价格',
      priceHint: '套餐价格按 USD 填写；启用 CNY 换算时会按汇率折算实扣金额。',
      subscriptionCnyPayPreview: 'CNY 通道实扣预览：{amount}',
      subscriptionCnyPayPreviewWithFee: '（含 {feeRate}% 手续费：{total}）',
      validityDays: '有效期（天）',
      validityUnit: '有效期单位',
      selectValidityUnit: '选择有效期单位',
      validityPermanentHint: '填 0 表示永久有效。',
      sortOrder: '排序',
      forSale: '上架状态',
      onSale: '上架',
      offSale: '下架',
      group: '分组',
      groupOptionalHint: '留空表示余额充值套餐；选择订阅分组表示订阅套餐。',
      groupId: '分组 ID',
      features: '功能特性',
      featuresHint: '每行一个特性',
      ...
      monthlyLimit: '月限额',
      unlimited: '无限制',
      externalSubscribe: '外部订阅',
      externalSubscribeHint: '启用后，用户点击套餐按钮时会打开外部链接或显示订阅说明，不创建站内支付订单。',
      externalSubscribeTargetType: '开通方式',
      externalSubscribeTargetUrl: '外部链接',
      externalSubscribeTargetDialog: '说明弹窗',
      externalSubscribeUrl: '外部订阅链接',
      externalSubscribeUrlPlaceholder: 'https://example.com/subscribe',
      externalSubscribeDialogText: '订阅说明',
      externalSubscribeDialogTextPlaceholder: '填写用户点击订阅后看到的说明...',
      externalSubscribeDialogTextHint: '支持换行，可用于说明联系、兑换或开通方式。',
      externalSubscribeTargetRequired: '请先配置外部订阅链接或说明文本',
      externalSubscribeUrlRequired: '请填写外部订阅链接',
      externalSubscribeDialogTextRequired: '请填写订阅说明文本',
